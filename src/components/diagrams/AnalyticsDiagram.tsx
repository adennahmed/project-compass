  ...
  return (
    ...
    >
      ...
      <g transform="translate(210 18)">
        <text x="0" y="18" fontFamily="Bricolage Grotesque, sans-serif" fontSize="22" fontWeight="600" fill="currentColor" stroke="none" letterSpacing="-0.5">
          427
        </text>
        <g
        ...
        >
          ...
          <text x="12" y="8" fontFamily="Martian Mono, monospace" fontSize="8" letterSpacing="0.5" fill="rgb(var(--signal))" stroke="none">
            +12%
          </text>
        </g>
        <text x="0" y="30" fontFamily="Martian Mono, monospace" fontSize="6" letterSpacing="1.4" fill="currentColor" fillOpacity="0.55" stroke="none">
          ACTIVE CUSTOMERS · 7D
        </text>
      ...
      <g transform="translate(210 64)">
        <text x="0" y="0" fontFamily="Martian Mono, monospace" fontSize="6" letterSpacing="1.4" fill="currentColor" fillOpacity="0.55" stroke="none">
          BY REGION
        </text>
        {BARS.map((b, i) => {
          const y = 10 + i * 16;
          return (
            <g key={b.label}>
              <text x="0" y={y + 6} fontFamily="Martian Mono, monospace" fontSize="6" letterSpacing="0.8" fill="currentColor" fillOpacity="0.6" stroke="none">
                {b.label.toUpperCase()}
              </text>
              <rect
                x="42"
              ...
              />
              <text x={42 + b.w + 4} y={y + 6} fontFamily="Martian Mono, monospace" fontSize="6" letterSpacing="0.5" fill="currentColor" fillOpacity="0.5" stroke="none">
                {Math.round(b.w * 1.4)}
              </text>
            </g>
          );
      ...
      <g transform="translate(210 188)">
        ...
        {QUALITY.map((q, i) => (
          <g key={q} transform={`translate(${i * 60} 10)`}>
            ...
            <text x="10" y="6" fontFamily="Martian Mono, monospace" fontSize="5" letterSpacing="1.2" fill="currentColor" fillOpacity="0.6" stroke="none">
              {q}
            </text>
          </g>
        ))}

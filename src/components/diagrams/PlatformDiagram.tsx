  ...
  return (
    ...
    >
      ...
      <g transform="translate(0 170)">
        ...
        <text x="14" y="14" fontFamily="Martian Mono, monospace" fontSize="7" letterSpacing="1.6" fill="currentColor" stroke="none">
          INFRASTRUCTURE
        </text>
        {/* postgres cylinder */}
        ...
        <text x="160" y="34" fontFamily="Martian Mono, monospace" fontSize="6" letterSpacing="1" fill="currentColor" fillOpacity="0.55" stroke="none">
        ...
        {METHODS.map((ep, i) => {
          ...
          return (
            <g key={i}>
              ...
              <text x={14 + tagWidth / 2} y={y + 0.5} fontFamily="Martian Mono, monospace" fontSize="5" textAnchor="middle" fill="currentColor" stroke="none">
                {ep.m}
              </text>
              <line
                x1={14 + tagWidth + 6}
              ...
              />
              <text x={20 + tagWidth + 6} y={y + 0.5} fontFamily="Martian Mono, monospace" fontSize="5" fill="currentColor" fillOpacity="0.5" stroke="none">
                {ep.label}
              </text>
            </g>
          );

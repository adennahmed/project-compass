...
const SECTIONS = [
  {
    ...
    body: "By accessing or using this portfolio website, you agree to be bound by these Terms and Conditions. If you do not agree with any part of these terms, you should not use the website.",
  },
  {
    n: "02",
    title: "Use of the Website",
    body: "This website is provided for informational purposes and to facilitate communication with Aden Ahmed. You agree not to use it for any unlawful purpose or in a way that could damage, disable, or impair its availability to others.",
  },
  {
    n: "03",
    title: "Intellectual Property",
    body: "All content on this website — including text, graphics, project concepts, and design — is the property of Aden Ahmed unless otherwise stated and is protected by applicable intellectual property laws.",
  },
  {
    n: "04",
    title: "Communications",
    body: "When you contact me through an email or linked platform, you consent to receiving a response using the details you provided.",
  },
  {
    n: "05",
    title: "No Warranties",
    body: "The website and its content are provided \"as is\" without warranties of any kind, express or implied. I do not warrant that the website will be uninterrupted, error-free, or free of harmful components.",
  },
  {
    n: "06",
    title: "Limitation of Liability",
    body: "Aden Ahmed shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of, or inability to use, this website or its content.",
  },
  {
    n: "07",
    title: "Governing Law",
  ...
  },
  {
    ...
    body: "These terms may be modified at any time. Changes will be posted on this page with a revised effective date. Continued use of the website after changes constitutes acceptance of the updated terms.",
  },
  {
    n: "09",
    title: "Contact",
    body: "For questions regarding these Terms and Conditions, contact me at hello@kozai.ca.",
  },
];
...
const TermsAndConditions = () => {
  ...
  return (
    <div className="min-h-screen bg-paper text-ink">
      <SEOHead
        title="Terms & Conditions — Aden Ahmed"
        description="Terms governing use of the Aden Ahmed portfolio website."
      ...
      <main className="mx-auto max-w-[760px] px-6 pb-32 pt-16 md:px-10">
        ...
        <p className="mt-10 max-w-[52ch] text-[15px] leading-[1.65] text-ink/70">
          These terms govern your use of the Aden Ahmed portfolio website and any communications

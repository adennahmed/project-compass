  ...
  return (
    ...
    >
      <button
        ...
        className="group block w-full pr-4 text-left transition-colors hover:bg-paper-2/40 md:pr-8"
      >
        <div className="grid grid-cols-12 items-baseline gap-4 py-10 md:gap-8 md:py-14">
          <div className="col-span-2 md:col-span-1">
            <span className="font-mono text-[12px] tracking-[0.18em] text-mute transition-colors group-hover:text-signal">
              {service.n}
            </span>
          </div>
          ...
          <div className="col-span-1 md:col-span-4 md:flex md:items-center md:justify-end md:gap-3">
            <span className="hidden font-mono text-[11px] uppercase tracking-[0.22em] text-mute transition-colors group-hover:text-ink md:inline">
              {isOpen ? "Close" : "Expand"}
            </span>
            <span
              aria-hidden
              className={`relative flex h-9 w-9 shrink-0 items-center justify-center border transition-colors duration-300 ${
                isOpen
                  ...
                  : "border-hairline/30 text-mute group-hover:border-ink group-hover:text-ink"
              }`}
            >
              <span
      ...
      <div className={`kz-service-expand ${isOpen ? "is-open" : ""}`}>
        <div className="grid grid-cols-12 gap-4 pb-12 pr-4 md:gap-8 md:pr-8">
          <div className="col-span-12 md:col-span-1" />
        ...
        <Reveal>
          <div className="mb-20 grid grid-cols-1 gap-8 md:grid-cols-12 md:items-end md:gap-12">
            <div className="md:col-span-3">
              <div className="label"><ScrambleText text="[ 01 — What we build ]" /></div>
            </div>
